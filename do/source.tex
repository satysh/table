...
\center{\includegraphics[width=1.\linewidth]{fig_1.png} \\ (a)}
\end{minipage}
\hfill
\begin{minipage}[h]{0.38\linewidth}
\center{\includegraphics[width=1.\linewidth]{fig_2.png} \\ (b)}
\end{minipage}
\vspace{0.05cm}
...
\center{\includegraphics[width=1.\linewidth]{fig_3.png} \\ (a)}
\end{minipage}
\hfill
\begin{minipage}[h]{0.48\linewidth}
\center{\includegraphics[width=1.\linewidth]{fig_4.png} \\ (b)}
\end{minipage}
\vspace{0.05cm}

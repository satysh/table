...
\author{I. Satyshev} % Write as First name Surname
 ...
 \affiliation{
  Joint Institute of Nuclear Research, Dubna, JINR.% Force line breaks with \\ if necessary
}
\affiliation{%
...
\affiliation{
 Bauman Moscow State Technical University, Moscow, BMSTU.% Force line breaks with \\ if necessary
}
\author{ B. Mauyey}
\affiliation{
  Joint Institute of Nuclear Research, Dubna, JINR.% Force line breaks with \\ if necessary
...
\hfill
\begin{minipage}[h]{0.45\linewidth}
\center{\includegraphics[width=0.88\linewidth]{fig_2.eps} \\ (b)}
\end{minipage}
\vspace{0.05cm}
...
\hfill
\begin{minipage}[h]{0.45\linewidth}
\center{\includegraphics[width=0.88\linewidth]{fig_4.eps} \\ (b)}
\end{minipage}
\vspace{0.05cm}
